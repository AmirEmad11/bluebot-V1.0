...
REGISTRATION_LINK = "https://lb-aff.com/L?tag=d_5013742m_22611c_site&site=5013742&ad=22611&r=registration"
CONTACT_USERNAME = "@elharam110"
TUTORIAL_LINK = "https://t.me/c/3296506024/13199"
...
في الأول لازم تسجّل في LineBet بحساب جديد بالبرومو كود او الرمز الترويجي الخاص بينا:   QQ33
ملحوظه : البرنامج يشبه 1Xbet بنسبه 100%

رابط التسجيل : 🔥🔥 https://lb-aff.com/L?tag=d_5013742m_22611c_site&site=5013742&ad=22611&r=registration

رابط تحميل التطبيق : https://lb-aff.com/L?tag=d_5013742m_66803c_apk1&site=5013742&ad=66803

بعدها بتحط إيداع 195 جنيه او اكتر، وبعدها بتستعمل إشاراتي الـ VIP عشان تكسب!

🚀 تابع قناتي وشوف بنفسك! 👇
https://t.me/+u4OtXpzXSt5hNjJk
...
⚠️ معلومة: الكود الترويجي QQ33 متاح لأول 50 شخص فقط كل يوم
...
✅ سجل واشحن الـ 165 جنيه
✅ جرب أول 3 إشارات
✅ لو ما كسبتش في واحدة منهم...
💰 أنا شخصياً أرجعلك الـ 165 جنيه كاملة!
...
async def generate_apple_game_with_video_support() -> Tuple[str, Dict]:
    ...
    game_text = f"✅ اشاره جديده ✅\nالاشاره لمده ٥ دقائق ⏰\n🍏 Apple oF Fortune 🍏\n\n{grid_text}\n\n‼️الاشاره تعمل فقط لمن استعمل الرمز الترويجي QQ33 عن التسجيل بحساب جديد\n‼️اقل ايداع عشان الإشارات تشتغل معاك هو  165 جنيه و في حاله الايداع بمبلغ اقل من 165 هتخسر للاسف\nرابط التسجيل : 🔥🔥 {REGISTRATION_LINK}\n\nلو عندك مشكلة او استفسارات تواصل مع : {CONTACT_USERNAME}"
